...
function Register() {
  ...
  const register = async () => {
    ...
    axios
      .post(
        process.env.NEXT_PUBLIC_BACKEND_URL + "/auth/passenger/register",
        data
      )
      .then((response) => {
        setIsPosting(false);
        toast.success(
          `${data.first_name} ${data.last_name} you are now registered use the USSD App to buy bus tickets`
        );
      })
      .catch((error) => {
        setIsPosting(false);
        try {
          ...
          if (status == 409) {
            toast.warning(
              `${data.phone_number}. This Phone Number is already registered`
            );
          } else {
        ...
        <div className="row g-4">
          <div className="col-md-6">
            ...
            <div className="input-group mb-3">
              ...
              <input
                ...
                className="form-control"
                required
                pattern="[0-9]{6}/[0-9]{1,2}/[0-9]{1,2}"
                placeholder="101010/10/1"
              />
              <div className="valid-feedback">Looks good!</div>
              <div className="invalid-feedback">incorrect NRC</div>
            </div>
          ...
          <div className="col-md-6">
            ...
            <div className="input-group mb-3">
              ...
              />
              <div className="valid-feedback">Looks good!</div>
              <div className="invalid-feedback">your passwords don match</div>
            </div>
          </div>
        </div>
