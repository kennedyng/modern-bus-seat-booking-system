...
const swaggerDocumentation = {
  openapi: "3.0.0",
  info: {
    title: "CLOUD E BUS RESERVATION API",
    version: "0.0.1",
  ...
  tags: [
    {
      name: "authorization",
      description:
        "The system is using a Bearer Token Authentication system. Generate A token by loging to the system as a **Operator or Passenger** ",
    },
    {
      name: "passenger",
